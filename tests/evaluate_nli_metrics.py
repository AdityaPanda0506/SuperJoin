...
from sklearn.metrics import classification_report, precision_recall_fscore_support  # noqa: E402
...
def run_evaluation():
        ...
        (
            GroundedFact(
                ...
                provenance=Provenance(
                    source_doc_name="prospectus.pdf",
                    doc_hash="h1",
                    page_number=14,
            ...
            GroundedFact(
                ...
                provenance=Provenance(
                    source_doc_name="annual_report.pdf",
                    doc_hash="h2",
                    page_number=2,
        ...
        (
            GroundedFact(
                ...
                provenance=Provenance(
                    ...
                    doc_hash="h1",
                    page_number=20,
                    verbatim_quote="total employees 66,000",
                ),
            ),
            GroundedFact(
                fact_id="c2_b",
                ...
                provenance=Provenance(
                    ...
                    doc_hash="h2",
                    page_number=40,
                    verbatim_quote="total workforce stood at 93,000",
                ),
            ),
        ...
        (
            GroundedFact(
                ...
                provenance=Provenance(
                    ...
                    doc_hash="h1",
                    page_number=35,
                    verbatim_quote="revenue in FY22 was Rs 7,241 Crores",
                ),
            ),
            GroundedFact(
                fact_id="c3_b",
                ...
                provenance=Provenance(
                    ...
                    doc_hash="h2",
                    page_number=10,
                    verbatim_quote="revenue in FY24 reached Rs 8,142 Crores",
                ),
            ),
        ...
        (
            ...
            GroundedFact(
                ...
                provenance=Provenance(
                    ...
                    doc_hash="h",
                    page_number=1,
                    verbatim_quote="this string does not exist on page",
                ),
            ),
    ...
    p_q, r_q, f1_q, _ = precision_recall_fscore_support(
        y_q_true, y_q_pred, average="binary", zero_division=0
    )
