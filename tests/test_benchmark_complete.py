...
try:
    from fact_layer.core.models import (  # noqa: E402
        ContextBoundingBox,
        GroundedFact,
        Provenance,
        TemporalInterval,
    )
    from fact_layer.core.normalizer import GeneralizedNormalizer  # noqa: E402
    from fact_layer.core.parser import DocumentParser  # noqa: E402
    from fact_layer.core.reconciler import FactReconciler  # noqa: E402
    from fact_layer.core.storage import IncrementalFactStore  # noqa: E402
    from fact_layer.core.validator import FactIntegrityGate  # noqa: E402
except ImportError:
    from core.models import ContextBoundingBox, GroundedFact, Provenance, TemporalInterval
...
class TestFactLayerProduction:
    ...
    def test_03_brownie3_dynamic_schema_macroeconomy(self):
        ...
        macro_files = [
            os.path.join(macro_dir, f) for f in os.listdir(macro_dir) if f.endswith(".pdf")
        ]
        ...
        macro_fact = GroundedFact(
            ...
            provenance=Provenance(
                source_doc_name=os.path.basename(macro_files[0]),
                doc_hash="macro_hash",
                page_number=1,
                verbatim_quote="Policy Repo Rate remained unchanged at 6.50%",
            ),
        )
    ...
    def test_04_brownie2_and_4_incremental_store_performance(self):
        ...
        f_d1_incorp = GroundedFact(
            ...
            provenance=Provenance(
                ...
                doc_hash="hash_d1",
                page_number=14,
                verbatim_quote="originally incorporated on June 22, 2011",
            ),
        )
        # Fact B: Revenue FY22
        f_d1_rev = GroundedFact(
            ...
            provenance=Provenance(
                ...
                doc_hash="hash_d1",
                page_number=35,
                verbatim_quote="revenue from operations for FY22 was Rs 7,241 Crores",
            ),
        )

        # Baseline Ingestion
        t0 = time.perf_counter()
        res_d1 = store.add_document_facts(
            [f_d1_incorp, f_d1_rev], doc_hash="hash_d1", doc_name="doc1.pdf"
        )
        ...
        f_d2_incorp = GroundedFact(
            ...
            provenance=Provenance(
                ...
                doc_hash="hash_d2",
                page_number=2,
                verbatim_quote="Delhivery Ltd was incorporated on 22nd June 2011",
            ),
        )
        f_d2_rev = GroundedFact(
            ...
            provenance=Provenance(
                ...
                doc_hash="hash_d2",
                page_number=10,
                verbatim_quote="consolidated revenue from operations reached Rs 8,142 Crores in FY24",
            ),
        )

        t1 = time.perf_counter()
        res_d2 = store.add_document_facts(
            [f_d2_incorp, f_d2_rev], doc_hash="hash_d2", doc_name="doc2.pdf"
        )
    ...
    def test_05_assignment_cases_1_through_4(self):
        ...
        f1_c1 = GroundedFact(
            ...
            provenance=Provenance(
                ...
                doc_hash="h1",
                page_number=14,
                verbatim_quote="incorporated on June 22, 2011",
            ),
        )
        f2_c1 = GroundedFact(
            fact_id="c1_b",
        ...
        f1_c2 = GroundedFact(
            ...
            provenance=Provenance(
                source_doc_name="doc_a.pdf",
                doc_hash="h1",
                page_number=20,
                verbatim_quote="permanent workforce was 66,000",
            ),
        )
        f2_c2 = GroundedFact(
            fact_id="c2_b",
            ...
            provenance=Provenance(
                source_doc_name="doc_b.pdf",
                doc_hash="h2",
                page_number=40,
                verbatim_quote="FY22 team stood at 93,000 employees",
            ),
        )
        ...
        f1_c3 = GroundedFact(
            fact_id="c3_a",
            entity="Delhivery",
            attribute="Network PIN Codes",
            raw_value="17,000",
            canonical_value=17000,
            context_box=ContextBoundingBox(
                temporal=TemporalInterval(
                    start_date="2021-04-01",
                    end_date="2022-03-31",
            ...
            provenance=Provenance(
                ...
                doc_hash="h1",
                page_number=4,
                verbatim_quote="covered 17,000 pin codes in FY22",
            ),
        )
        f2_c3 = GroundedFact(
            fact_id="c3_b",
            ...
            provenance=Provenance(
                ...
                doc_hash="h2",
                page_number=12,
                verbatim_quote="network expanded to 18,500 pin codes in FY24",
            ),
        )
        ...
        bad_fact_numeric = GroundedFact(
            ...
            raw_value="86",
            canonical_value=86.0,
            context_box=ContextBoundingBox(
                temporal=TemporalInterval(
                    start_date=None, end_date=None, granularity="UNKNOWN", raw_expression=""
                ),
                scope="INDIA",
                canonical_unit="COUNT",
            ),
            provenance=Provenance(
                ...
                doc_hash="h1",
                page_number=8,
                verbatim_quote="operating 86 active gateways",
            ),
        )
        bad_fact_quote = GroundedFact(
            fact_id="c4_bad_quote",
            entity="Delhivery",
            attribute="Status",
            raw_value="Operational",
            canonical_value="Operational",
            context_box=ContextBoundingBox(
                temporal=TemporalInterval(
                    start_date=None,
                    end_date=None,
            ...
            provenance=Provenance(
                ...
                doc_hash="h1",
                page_number=8,
                verbatim_quote="hallucinated string not present in document text",
            ),
        )
        ...
        valid_facts, quarantined_facts = FactIntegrityGate.validate_facts(
            facts=[bad_fact_numeric, bad_fact_quote], page_text_map=page_texts_map
        )
